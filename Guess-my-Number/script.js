...
// document.querySelector('.guess').value = 23;            //directly manipulating the live HTML element's value
// console.log(document.querySelector('.guess').value);
*/
/*
// const x = function () {
//     console.log(23);
// }        //instead of the below function we can also give const x ,coz both are same
*/
